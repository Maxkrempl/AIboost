...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function incrementUsage() {
        ...
        updateUsageDisplay();
        if (usageCount >= 2) showUpgradeModal();
    }
    ...
    function checkLimit() {
        if (usageCount >= 2) { showUpgradeModal(); return false; }
        return true;
    }
    ...
    document.getElementById('seo-submit').addEventListener('click', async () => {
        ...
        try {
            const resp = await fetch('/api/functions/seo-audit.php', {
                method: 'POST',
    ...
    document.getElementById('geo-submit').addEventListener('click', async () => {
        ...
        try {
            const resp = await fetch('/api/functions/geo-check.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    document.getElementById('ad-submit').addEventListener('click', async () => {
        ...
        showLoader(adResult);
        try {
            const resp = await fetch('/api/functions/ad-copy.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    document.getElementById('listing-submit').addEventListener('click', async () => {
        ...
        try {
            const resp = await fetch('/api/functions/listing-optimize.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
