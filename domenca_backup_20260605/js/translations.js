...
const translations = {
  en: {
    ...
    "hero.subtitle": "Hi, I'm Darko — a developer and indie maker from Slovenia. I create AI‑powered tools that help restaurants, marketers, and businesses grow. Simple, effective, and built to scale.",
    ...
    "about.who.p1": "I'm a <strong>Slovenian full-stack developer and indie SaaS maker</strong>. I'm the founder of <strong>HD Web Design</strong> and the creator of three AI-powered SaaS products: <a href='/menu-boost/'>MenuBoost</a>, <a href='/boost-suite/'>BoostSuite</a>, and <a href='/ad-boost/'>AdBoost</a>.",
  ...
  si: {
    ...
    "hero.subtitle": "Živjo, sem Darko — razvijalec in indie maker iz Slovenije. Ustvarjam AI orodja, ki pomagajo restavracijam, tržnikom in podjetjem rasti. Preprosto, učinkovito in zgrajeno za skaliranje.",
    ...
    "about.who.p1": "Sem <strong>slovenski full-stack razvijalec in indie SaaS ustvarjalec</strong>. Ustanovitelj sem <strong>HD Web Design</strong> in ustvarjalec treh AI SaaS produktov: <a href='/menu-boost/'>MenuBoost</a>, <a href='/boost-suite/'>BoostSuite</a> in <a href='/ad-boost/'>AdBoost</a>.",
