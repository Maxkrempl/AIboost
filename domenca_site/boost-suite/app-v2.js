...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('seo-submit').addEventListener('click', async () => {
        ...
        try {
            const resp = await fetch('/api/proxy.php?fn=seo-audit', {
                method: 'POST',
    ...
    document.getElementById('geo-submit').addEventListener('click', async () => {
        ...
        try {
            const resp = await fetch('/api/proxy.php?fn=geo-check', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    document.getElementById('ad-submit').addEventListener('click', async () => {
        ...
        showLoader(adResult);
        try {
            const resp = await fetch('/api/proxy.php?fn=ad-copy', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    document.getElementById('listing-submit').addEventListener('click', async () => {
        ...
        try {
            const resp = await fetch('/api/proxy.php?fn=listing-optimize', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
