...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('seo-submit').addEventListener('click', async () => {
        ...
        try {
            const resp = await fetch('https://boostsuite.netlify.app/.netlify/functions/seo-audit', {
                method: 'POST',
    ...
    document.getElementById('geo-submit').addEventListener('click', async () => {
        ...
        try {
            const resp = await fetch('https://boostsuite.netlify.app/.netlify/functions/geo-check', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    document.getElementById('ad-submit').addEventListener('click', async () => {
        ...
        showLoader(adResult);
        try {
            const resp = await fetch('https://boostsuite.netlify.app/.netlify/functions/ad-copy', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    document.getElementById('listing-submit').addEventListener('click', async () => {
        ...
        try {
            const resp = await fetch('https://boostsuite.netlify.app/.netlify/functions/listing-optimize', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
