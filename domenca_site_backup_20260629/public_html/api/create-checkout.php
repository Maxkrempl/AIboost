...
$priceMap = [
    ...
    'ai_authority' => $config['prices']['ai_authority_onetime'],
    'ai_authority_monthly' => $config['prices']['ai_authority_monthly'],
];
...
$mode = 'subscription';
if ($priceId === 'ai_authority') {
    $mode = 'payment';
}

// Use AI Authority success page for AI Authority products
$successUrl = $config['success_url'];
if ($priceId === 'ai_authority' || $priceId === 'ai_authority_monthly') {
    $successUrl = 'https://hd-webdesign.si/success-ai-authority.html';
}
...
if ($mode === 'subscription') {
    $postData['subscription_data[metadata][product]'] = $productName;
    $postData['subscription_data[metadata][source]'] = 'hd-webdesign.si';
}
